#region Doc
/// @function AbilityCaster_AddEffectToBuffer(id_target, arr_effectData) Add a an effect to the given AbilityCaster's effect buffer
...
/// @param {arr} arr_effectData to add to the buffer.
#endregion
