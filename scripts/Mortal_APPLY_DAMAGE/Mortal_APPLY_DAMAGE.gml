...
var _num_damageListSize = ds_list_size(list_DamageData_damageList);
var _num_applyDamage = 0;

for (var i = 0; i < _num_damageListSize; i++){
	_num_applyDamage += Mortal_CALCULATE_RECEIVED_DAMAGE(list_DamageData_damageList[| i]);
}
...
ds_list_clear(list_DamageData_damageList);
