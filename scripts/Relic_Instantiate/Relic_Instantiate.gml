/// @function Relic_Instantiate(obj_relicChild, str_name, enum_rarity, ds_Stats_stats, arr_enum_effects)
///		Instantiates the given relic and initialises it with the given values.
/// @param {object} obj_relicChild The object index of the relic child to instantiate.
...
var _obj_relicChild = argument[0];
...
if (!object_is_ancestor(_obj_relicChild, oRelic)) {
	ErrorHandler_FatalError("Attempted to instantiate object that doesn't inherit from oRelic, object was " + object_get_name(_obj_relicChild));
}
