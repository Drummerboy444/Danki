#region Doc
/// @function Passive_Setup(bool_hasOneShotService, bool_hasChannelService, map_baseStats, scr_plan)
...
AbilityCaster_Setup(_bool_hasOneShotService, _bool_hasChannelService, _map_baseStats, _scr_plan);
