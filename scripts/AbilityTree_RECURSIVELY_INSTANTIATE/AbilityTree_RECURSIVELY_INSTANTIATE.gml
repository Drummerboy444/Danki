#region Doc
/// @function AbilityTree_RECURSIVELY_INSTANTIATE(map_abilityNode, id_parent) Takes a map of an ability in the ability
...
if (_map_leftChild != noone) {
	_id_leftChild = AbilityTree_RECURSIVELY_INSTANTIATE(_map_leftChild, _id_currentNode);
}
if (_map_rightChild != noone) {
	_id_rightChild = AbilityTree_RECURSIVELY_INSTANTIATE(_map_rightChild, _id_currentNode);
}
