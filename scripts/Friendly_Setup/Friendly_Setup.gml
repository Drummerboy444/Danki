#region Doc
/// @function Friendly_Setup(bool_hasOneShotService, bool_hasChannelService, map_baseStats, scr_plan, num_agroRange)
...
/// @param {number} num_agroRange The agro range of the friendly object.
#endregion
...
NPC_Setup(_bool_hasOneShotService, _bool_hasChannelService, _map_baseStats, _scr_plan, _num_agroRange);