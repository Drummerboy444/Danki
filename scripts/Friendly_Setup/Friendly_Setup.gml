#region Doc
/// @function Friendly_Setup(bool_hasOneShotService, bool_hasChannelService, map_baseStats, scr_plan)
...
NPC_Setup(_bool_hasOneShotService, _bool_hasChannelService, _map_baseStats, _scr_plan);