/// @function ds_Inventory_SetWearable(ds_Inventory_inv, id_wearable, enum_wearableType) Sets the given wearable
...
/// @param {enum} enum_wearableType The slot to add the wearable in, the previous item will be overridden.
