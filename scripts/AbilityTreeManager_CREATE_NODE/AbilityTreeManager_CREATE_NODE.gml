#region Doc
/// @function AbilityTreeManager_CREATE_NODE(scr_ability, id_parent, id_leftNode, id_rightNode) Instantiates
///		an AbilityTreeNode with the given values.
...
var _id_leftNode = argument[2];
var _id_rightNode = argument[3];
