...
var list_effects = _id_abilityCaster.list_activeEffects;

for(var i=0; i<ds_list_size(list_effects); i++){
	if(EffectData_GetEffect(list_effects[| i]) == _enum_effect) return true;
}
