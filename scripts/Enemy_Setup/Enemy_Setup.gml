#region Doc
/// @function Enemy_Setup(bool_hasOneShotService, bool_hasChannelService, ds_Stats_baseStats, scr_plan)
...
/// @param {ds_Stats} ds_Stats_baseStats The immutable base stats of the enemy: map from stats to their values.
