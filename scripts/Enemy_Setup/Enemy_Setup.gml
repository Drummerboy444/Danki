#region Doc
/// @function Enemy_Setup(bool_hasOneShotService, bool_hasChannelService, map_baseStats, scr_plan, num_agroRange)
...
/// @param {number} num_agroRange The agro range of the enemy.
#endregion
