/// @function AbilityCaster_applyOnReceiveDamageEffects(id_abilityCaster, ds_DamageData_data) Applies on receive damage effects.
...
with(_id_abilityCaster){
	return AbilityCaster_APPLY_EFFECTS(Enum_EventHooks.ON_RECEIVE_DAMAGE, _ds_DamageData_data);
}