if (InputManager_CHECK_PRESSED(Enum_PlayerActions.LEFT_ABILITY) and instance_exists(oPlayer)){
	OneShotService_Cast(oPlayer.id_oneShotService, Enum_Abilities.YELLOW_CIRCLE, mouse_x, mouse_y);
}
if (InputManager_CHECK_DOWN(Enum_PlayerActions.RIGHT_ABILITY) and instance_exists(oPlayer)){
